...
-- MINUS
-- (SELECT CUSTOMER_NAME FROM(SELECT CUSTOMER_NAME,BRANCH_NAME FROM(SELECT DISTINCT CUSTOMER_NAME FROM CUSTOMER),(SELECT DISTINCT BRANCH_NAME FROM BRANCH WHERE BRANCH_CITY='Brooklyn')
-- MINUS
